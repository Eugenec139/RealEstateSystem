...
class UserCreationForm(forms.ModelForm):
    ...
    def clean_password2(self):
        ...
        if not len(password2) < 8:
            raise forms.ValidationError("The password must be at least 8 charecters ")
...
class UserChangeForm(forms.ModelForm):
    ...
    class Meta:
        model = MyUser
        fields = ('email', 'password', 'account_type', 'is_active', 'is_admin')
...
class UserAdmin(BaseUserAdmin):
    ...
    list_display = ('email', 'account_type', 'is_admin')
